...
latlong = [1.364809, 103.999221]   #rfdf latlong
frame=pd.read_csv('T_template_1.csv')
...
#drone > freq > height
#partitions1= P4 2.4 <100, P4 2.4 <300, P4 2.4 300
#partitions2= P4 5.8 <100, P4 5.8 <300, P4 5.8 300
#partitions3= Mavic 1 2.4, Mavic 2 2.4, Mavic 2 5.8

toprocess=frame #loop
partitions1_1=toprocess[(toprocess['Height']<=100)&(toprocess['Drone']=='P4')&(toprocess['Freq']==2.4)]
partitions1_2=toprocess[(toprocess['Height']<250)&(toprocess['Height']>100)&(toprocess['Drone']=='P4')&(toprocess['Freq']==2.4)]
partitions1_3=toprocess[(toprocess['Height']>=250)&(toprocess['Height']<=300)&(toprocess['Drone']=='P4')&(toprocess['Freq']==2.4)]
partitions2_1=toprocess[(toprocess['Height']<=100)&(toprocess['Drone']=='P4')&(toprocess['Freq']==5.8)]
partitions2_2=toprocess[(toprocess['Height']<250)&(toprocess['Height']>100)&(toprocess['Drone']=='P4')&(toprocess['Freq']==5.8)]
partitions2_3=toprocess[(toprocess['Height']>=250)&(toprocess['Height']<=300)&(toprocess['Drone']=='P4')&(toprocess['Freq']==5.8)]
partitions3_1=toprocess[(toprocess['Drone']=='Mavic 1')&(toprocess['Freq']==2.4)]
partitions3_2=toprocess[(toprocess['Drone']=='Mavic 2')&(toprocess['Freq']==2.4)]
partitions3_3=toprocess[(toprocess['Drone']=='Mavic 2')&(toprocess['Freq']==5.8)]

partitions=[partitions1_1,partitions1_2,partitions1_3,partitions2_1,partitions2_2,partitions2_3,partitions3_1,partitions3_2,partitions3_3]
...
legend_html =   '''
                <div style="background: #C8C8C8;
                            ...
                            >
                            &nbsp; <b><u>Legend</u><b></br>
                            <br>&nbsp; Test: %s, %0.1fGHz at 100m, 200m & 300m height &nbsp;<br>
